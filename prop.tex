...
\end{itemize}
%\vspace{-0.15in}
These individuals are using the largest ground-based telescopes, the best space facilities, and the largest and newest radio (cm/mm) interferometers on the planet.  Together they account for much of the data on gas in dense environments, and over a large baseline in cosmic time.  
...
However, it is still not clear whether the clusters actively alter the gas content
